      ...
      <!-- <footer class="bd-footer text-muted navbar-fixed-bottom" style='
                                                              width:100%;
                                                              font-size: 85%;
      ...
      <!-- <footer class="navbar navbar-fixed-bottom" style='
                                                        ...
                                                        min-height: 8vh'>
        <div class="container-fluid" style='min-height: inherit; padding-left: 2px;'>
          <div class="navbar-header" style="min-height: inherit;">
            <label class="navbar-brand" style="padding-top: 2.5vh; color: white; min-height: inherit; margin-bottom: 0px; font-size: 1000%; padding-left: 0px;" href="#">
              HARTNETT
            </label>
          </div>
          <ul class="nav navbar-nav navbar-right socialLinks" >
            ...
            <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 49.652 49.652" style="enable-background:new 0 0 49.652 49.652;" xml:space="preserve">
            <g>
              <g>
                <g>
            ...
            <li><a href="#" style="color: white; font-size: 200%; padding-top:30px">CCC</a></li>
      ...
      <footer class="footer navbar navbar-fixed-bottom navbar-inverse" style="background-color: rgb(50,50,50);min-height:11%">
        ...
        <ul class="nav navbar-nav navbar-right socialLinks" style="border:0px blue dotted;min-height:11vh;padding:2vh; margin-right:1vw;">
          ...
          <li><a href="https://www.instagram.com/hartnett_gallery/?hl=en"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 49.652 49.652" style="enable-background:new 0 0 49.652 49.652;" xml:space="preserve">
          <g>
            <g>
              <g>
                <path d="M24.825,29.796c2.739,0,4.972-2.229,4.972-4.97c0-1.082-0.354-2.081-0.94-2.897c-0.903-1.252-2.371-2.073-4.029-2.073     c-1.659,0-3.126,0.82-4.031,2.072c-0.588,0.816-0.939,1.815-0.94,2.897C19.854,27.566,22.085,29.796,24.825,29.796z" fill="#FFFFFF"/>
          ...
          <li><a href="https://ccc.rochester.edu/organization/hartnettgallerycommittee" style="color: white; font-size: 4vh; padding-top:30px; font-weight:100;">CCC</a></li>
          <!-- <li><a href="#" style="color: white; font-size: 200%; padding-top:30px">RSS</a></li> -->
        </ul>
      </footer>
